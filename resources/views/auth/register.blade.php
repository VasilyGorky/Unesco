                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('secondname') ? ' is-invalid' : '' }}" name="secondname" value="{{ old('secondname') }}" required autofocus>
                        ...
                        <div class="form-group row" style="margin-bottom: -5px">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Пол') }}</label>
                            <p>
                                <input style="margin-left: 20px; margin-top: 10px" class="w3-radio" type="radio" name="gender" value="male" checked>
                                <label>Мужской</label>
